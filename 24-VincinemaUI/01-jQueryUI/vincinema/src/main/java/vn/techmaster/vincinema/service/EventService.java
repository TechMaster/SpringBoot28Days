...
public class EventService {
  ...
  public List<Event> findByEventRequest(FindEventRequest findEventRequest) {
    //https://reflectoring.io/spring-data-specifications/
    //https://github.com/thombergs/code-examples/blob/master/spring-boot/specification/src/main/java/io/reflectoring/specification/repository/CustomProductRepository.java
    //https://www.logicbig.com/tutorials/spring-framework/spring-data/combined-specifications.html
    if (findEventRequest.getShowDate().isBlank()) {
      return eventRepo.findByFilmTitleLikeAndRoomCinemaId("%" + findEventRequest.getFilmTitle() + "%", findEventRequest.getCinemaID());
    } else {
      return eventRepo.findByDateAndFilmTitleLikeAndRoomCinemaId("%" + findEventRequest.getShowDate() + "%", findEventRequest.getFilmTitle(), findEventRequest.getCinemaID());
    }
  }
