...
class BarcelonateamApplicationTests {
	...
	@Test
	@DisplayName(" 6. /chooseteam/118 should return 404")
	void chooseTeam118() {		
		try {
			webClient.get()
        .uri(uriBuilder -> uriBuilder
	...
	@Test
	@DisplayName(" 7. /chooseteam/000 should return 404")
	void chooseTeam000() {		
		try {
			webClient.get()
        .uri(uriBuilder -> uriBuilder
	...
	@Test
	@DisplayName(" 8. /chooseteam/345 should return 404")
	void chooseTeam345() {		
		try {
			webClient.get()
        .uri(uriBuilder -> uriBuilder
	...
	void subtituteANumerNotInTeam() {		
        ...
        .bodyToMono(new ParameterizedTypeReference<TeamStatus>() {})
			...
			assertThat(e.getHttpStatus()).isEqualTo(HttpStatus.BAD_REQUEST);
			assertThat(e.getMessage()).isEqualTo("TeamException : Invalid player number");
		}
	}
